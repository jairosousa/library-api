...
public class BookControllerTest {
    ...
    public void updateBookTest() throws Exception {
        ...
        Book updateBook = Book.builder().id(1L).title("some title").author("some author").isbn("321").build();

        BDDMockito.given(service.getById(Mockito.anyLong())).willReturn(Optional.of(updateBook));
        BDDMockito.given(service.update(Mockito.any(Book.class))).willReturn(updateBook);
    ...
    public void updatenexistentBookITest() throws Exception {
    ...
    public void findBookTest() throws Exception {
        ...
        PageImpl<Book> page = new PageImpl<Book>(Arrays.asList(book), PageRequest.of(0, 100), 1);
